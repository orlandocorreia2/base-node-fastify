...
type FindOnePermissionGroupResponseProps = {
  result: PermissionGroup;
  reply: FastifyReply;
};

export class FindOnePermissionGroupResponse extends BaseResponse {
  static success({ result, reply }: FindOnePermissionGroupResponseProps) {
    const dataResult = {
      id: result.id,
      name: result.name,
